 ...
 */
class ImportPropertyModel extends AbstractImportModel
{
    /** @var Property */
    protected $obModel;
    ...
    /**
     * ImportPropertyModel constructor.
     */
    ...
    {
        $this->arSettings['is_translatable'] = (bool) array_get($this->arImportData, 'is_translatable');
