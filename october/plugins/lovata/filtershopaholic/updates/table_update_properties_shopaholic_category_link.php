...
/**
 * Class TableUpdatePropertiesShopaholicCategoryLink
 * @package Lovata\FilterShopaholic\Updates
 */
class TableUpdatePropertiesShopaholicCategoryLink extends Migration
{
    /**
     * Apply migration
     */
    public function up()
    {
        ...
        if(Schema::hasTable('lovata_properties_shopaholic_product_link')
            && !Schema::hasColumn('lovata_properties_shopaholic_product_link', 'in_filter')
        ) {
            Schema::table('lovata_properties_shopaholic_product_link', function(Blueprint $table)
            {
        ...
        if(Schema::hasTable('lovata_properties_shopaholic_offer_link')
            && !Schema::hasColumn('lovata_properties_shopaholic_offer_link', 'in_filter')
        ) {
            Schema::table('lovata_properties_shopaholic_offer_link', function(Blueprint $table)
            {
                $table->boolean('in_filter')->default(false);
                $table->string('filter_type')->nullable();
                $table->string('filter_name')->nullable();
