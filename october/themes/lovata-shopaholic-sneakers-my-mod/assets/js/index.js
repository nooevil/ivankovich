...
/***/ "./themes/lovata-shopaholic-sneakers/pages/index.js":
/*!**********************************************************!*\
  !*** ./themes/lovata-shopaholic-sneakers/pages/index.js ***!
  \**********************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _partials_content_main_slider_main_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../partials/content/main-slider/main-slider */ "./themes/lovata-shopaholic-sneakers/partials/content/main-slider/main-slider.js");
/* harmony import */ var _partials_product_two_level_slider_two_level_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../partials/product/two-level-slider/two-level-slider */ "./themes/lovata-shopaholic-sneakers/partials/product/two-level-slider/two-level-slider.js");
/* harmony import */ var _partials_content_big_slider_big_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../partials/content/big-slider/big-slider */ "./themes/lovata-shopaholic-sneakers/partials/content/big-slider/big-slider.js");
/* harmony import */ var _partials_article_news_slider_news_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../partials/article/news-slider/news-slider */ "./themes/lovata-shopaholic-sneakers/partials/article/news-slider/news-slider.js");
/* harmony import */ var _partials_content_brand_slider_brand_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../partials/content/brand-slider/brand-slider */ "./themes/lovata-shopaholic-sneakers/partials/content/brand-slider/brand-slider.js");
/* harmony import */ var _partials_form_subscribe_subscribe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../partials/form/subscribe/subscribe */ "./themes/lovata-shopaholic-sneakers/partials/form/subscribe/subscribe.js");
/* * Slider * */
...
/***/ "./themes/lovata-shopaholic-sneakers/partials/article/news-slider/news-slider.js":
/*!***************************************************************************************!*\
  !*** ./themes/lovata-shopaholic-sneakers/partials/article/news-slider/news-slider.js ***!
  \***************************************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (new class blogSlider {
  ...
  init() {
    ...
    const slider = document.querySelector(".".concat(this.sliderContainerSelector));
    if (!slider) return;
    const slides = slider.querySelectorAll(".".concat(this.slideSelector));
  ...
  changeSlider() {
    const btn = document.querySelectorAll(".".concat(this.tabBtnSelector));
    if (!btn) return;
  ...
  sliderTabHandler(el) {
    if (el.matches(".".concat(this.tabActiveRtnSelector))) return;
    ...
    $.request('ArticleList::onAjaxRequest', {
      ...
      update: {
        'article/news-slider/news-slider-ajax': ".".concat(this.sliderAjaxWrapperSelector)
      },
...
/***/ "./themes/lovata-shopaholic-sneakers/partials/content/big-slider/big-slider.js":
/*!*************************************************************************************!*\
  !*** ./themes/lovata-shopaholic-sneakers/partials/content/big-slider/big-slider.js ***!
  \*************************************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (new class BigSlider {
  constructor() {
  ...
  init() {
    const slider = document.querySelector(".".concat(this.sliderContainerSelector));
    if (!slider) return;
    const slides = slider.querySelectorAll(".".concat(this.slideSelector)).length;
    const {
      navigation
    } = this;
    this.BigSlider = new _common_custom_swiper_custom_swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".".concat(this.sliderContainerSelector), {
      slidesPerView: 1,
      spaceBetween: 0,
      loopedSlides: 4,
      watchOverflow: true,
...
/***/ "./themes/lovata-shopaholic-sneakers/partials/content/brand-slider/brand-slider.js":
/*!*****************************************************************************************!*\
  !*** ./themes/lovata-shopaholic-sneakers/partials/content/brand-slider/brand-slider.js ***!
  \*****************************************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (new class brandSlider {
  constructor() {
...
/***/ "./themes/lovata-shopaholic-sneakers/partials/content/main-slider/main-slider.js":
/*!***************************************************************************************!*\
  !*** ./themes/lovata-shopaholic-sneakers/partials/content/main-slider/main-slider.js ***!
  \***************************************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (new class HeroSlider {
  constructor() {
  ...
  init() {
    ...
    this.HeroSlider = new _common_custom_swiper_custom_swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".".concat(this.sliderContainerSelector), {
      slidesPerView: 1,
      spaceBetween: 0,
      watchOverflow: true,
      watchSlidesVisibility: true,
...
/***/ "./themes/lovata-shopaholic-sneakers/partials/product/two-level-slider/two-level-slider.js":
/*!*************************************************************************************************!*\
  !*** ./themes/lovata-shopaholic-sneakers/partials/product/two-level-slider/two-level-slider.js ***!
  \*************************************************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (new class TwoLevelSlider {
  constructor() {
  ...
  init() {
    ...
    this.TwoLevelSlider = new _common_custom_swiper_custom_swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".".concat(this.sliderContainerSelector), {
      slidesPerView: 2,
      slidesPerColumn: 2,
      slidesPerGroup: 4,
      spaceBetween: 15,
      ...
      on: {
        init: () => {
          const slider = document.querySelector(".".concat(this.sliderContainerSelector));
          const wrapper = slider.querySelector(".".concat(this.wrapperSelector));
  ...
  sliderTabHandler(el) {
    ...
    $.request('ProductList::onAjaxRequest', {
      ...
      update: {
        'product/two-level-slider/two-level-slider-ajax': ".".concat(this.sliderAjaxWrapper)
      },
      success: function success(res) {
        // eslint-disable-line object-shorthand, func-names
        this.success(res);
...
/***/ 1:
/*!****************************************************************!*\
  !*** multi ./themes/lovata-shopaholic-sneakers/pages/index.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /sr/apache/vivankovich.com/october/themes/lovata-shopaholic-sneakers/pages/index.js */"./themes/lovata-shopaholic-sneakers/pages/index.js");
